...
tbl_names_popular |> 
  ...
  labs(
    title = 'Most Popular Babynames in US',
    subtitle = 'Emma and Noah are the Most Popular Babynames of the Decade',
    caption = 'Source:SSA',
    x = 'No:of Births',
    y = 'Names'
  ) +
...
tbl_names_by_letter |> 
  ...
  labs(
    title = 'Percentage Distribution of Births based on First Letter of name in 2020',
      subtitle = 'A and J are the most common first letters among male and female citizens respectively',
    x = 'First Letter',
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "Percentage of Women born were higher than Men for names starting in S",
      caption = "Source:SSA",
      x = "Years",
      y = 'Percentage of Births'
    ) +
